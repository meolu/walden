...
(function (a, b) {
    a.fn.ace_tree = function (d) {
        ...
        this.each(function () {
            console.log('x')
            var e = a(this);
            //var dom = c['type'] == 'item' && c['url'] ? 'a'
            console.log(d);
            e.html('<div class = "tree-folder" style="display:none;"><div class="tree-folder-header">'
                + '<i class="' + c["close-icon"] + '"></i><div class="tree-folder-name"></div></div>'
                + '<div class="tree-folder-content"></div><div class="tree-loader" style="display:none"></div></div>'
                + '<div class="tree-item" style="display:none;">'
                + (c["unselected-icon"] == null ? "" : '<i class="' + c["unselected-icon"] + '"></i>')
                + (c.type == 'item' && c.url ? '<a class="tree-item-name" href="/xx"></a>' : '<div class="tree-item-name"></div>')
                + '</div>');
